  ...
  void mouseHandler(GLFWwindow* window, Cloth &cloth, const glm::mat4 &projection, const glm::mat4 &view, const glm::vec3 &cameraPos);
...
void mouseButtonCallback(GLFWwindow* window, int button, int action, int mods)
{
    ...
    mouseHandler(window, *cloth, projection, view, camera.Position);
}
