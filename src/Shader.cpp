...
Shader::Shader(const char* vertexPath, const char* fragmentPath)
{
    ...
    // ensure ifstream objects can throw exepcations:
    ...
    try
    {
        ...
        // read file's buffer contents into streeams
        vShaderStream << vShaderFile.rdbuf();
        fShaderStream << fShaderFile.rdbuf();
        // close file handlesrs
        vShaderFile.close();
        fShaderFile.close();
        // converst stream into string
    ...
    // delete shaders as thery lionked into our program
